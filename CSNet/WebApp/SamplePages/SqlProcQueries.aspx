...
&nbsp;
            ...
            <tr>
                <td align="center">
                    <asp:GridView ID="CategoryProductList" runat="server" AutoGenerateColumns="False" CellPadding="5" CellSpacing="5" GridLines="Horizontal" BorderStyle="None" HeaderStyle-Width="10" AllowPaging="True" OnPageIndexChanging="CategoryProductList_PageIndexChanging" OnSelectedIndexChanged="CategoryProductList_SelectedIndexChanged" PageSize="5">
